...
import signup from '../../assets/images/Sign-up-page.jpg';
...
const SignUp = () => {
	...
	const handleSignUp = (event) => {
		...
		if (password.length < 6) {
			return setError('Please give at least 6 characters password');
		}
		if (photo === '') {
			return setError('Please enter your PhotoUrl');
		}
	...
	return (
		<div className='md:flex justify-center items-center px-10 mt-10 mb-5'>
			<div className='md:w-1/2 w-11/12'>
				<img
					className='w-10/12 shadow-2xl rounded-full p-3'
					src={signup}
					alt=''
				/>
			</div>
			<div className=' shadow-xl bg-[#0a192f] text-cyan-600 flex justify-center rounded'>
