...
const Footer = () => {
	return (
		<footer className='px-4 divide-y dark:bg-gray-800 bg-[#0a192f] text-white dark:text-gray-100'>
							...
							<ul className='mt-8 space-y-4'>
								<li>
									<a
										href='#'
										title=''
										className='text-blue-200 transition-all duration-200 hover:text-white focus:text-white'></a>
								</li>
					...
					<div className='mt-20 md:mt-28 2xl:mt-32'>
						<div className='lg:flex lg:items-center lg:justify-between'>
							...
							<p className='mt-6 text-sm text-blue-200 lg:mt-0'>
								© Copyright 2023, All Rights Reserved by LEGO TOYS
							</p>
						</div>
					</div>
				</div>
